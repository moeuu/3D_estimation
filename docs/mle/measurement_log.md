...
The online backend reconstructs `RuntimeObservationModel` and `ContinuousKernel`
directly from the live `RunContext`. It does not maintain a second copy of detector,
shield, obstacle, or spectrum physics.
